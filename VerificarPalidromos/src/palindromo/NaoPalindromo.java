...
public class NaoPalindromo extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    NaoPalindromo quadro = new NaoPalindromo();
    ...
    public NaoPalindromo() {
        ...
        JButton botaoVerificar = new JButton("Verificar Palíndromo");
        botaoVerificar.setBounds(120, 50, 200, 30);
        botaoVerificar.addActionListener(e -> verificarPalindromo());
        painelConteudo.add(botaoVerificar);

        // Botão para remover caracteres especiais
        JButton botaoRemoverCaracteres = new JButton("Remover Caracteres Especiais");
        botaoRemoverCaracteres.setBounds(120, 90, 200, 30);
        botaoRemoverCaracteres.addActionListener(e -> removerCaracteresEspeciais());
        painelConteudo.add(botaoRemoverCaracteres);

        // Botão para verificar se o texto está vazio ou nulo
        JButton botaoVerificarVazio = new JButton("Verificar Vazio");
        botaoVerificarVazio.setBounds(120, 130, 200, 30);
        ...
        botaoConverterMaiusculas.setBounds(120, 170, 200, 30);
