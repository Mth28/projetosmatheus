...
public class DescontoValido extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DescontoValido frame = new DescontoValido();
    ...
    private void calcularDesconto() {
        try {
            ...
            if (porcentagemDesconto < 0 || porcentagemDesconto > 100) {
                lblFeedback.setText("Porcentagem de desconto inválida. Deve estar entre 0 e 100.");
                return;
            }
